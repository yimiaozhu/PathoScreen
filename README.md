...
* `models.ckpt` — pretrained scFoundation model
* `input_cell_matrix.pkl` — **gene-level cell embeddings generated by scFoundation** 

1. Download the files from the following links:

   - models.ckpt (provided by original authors):
